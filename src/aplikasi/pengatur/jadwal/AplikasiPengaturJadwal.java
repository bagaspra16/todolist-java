 ...
 */
package aplikasi.pengatur.jadwal;
...
class Task extends JPanel {
    ...
    Task() {
        ...
        taskName = new JTextField("Masukan kegiatanmu disini..."); // create task name text field
...
class List extends JPanel {
    ...
    Color lightColor = new Color(2, 32, 120);
...
class Footer extends JPanel {
    ...
    Footer() {
        ...
        addTask = new JButton("Tambah"); // add task button
        ...
        clear = new JButton("Bersihkan tugas yang sudah"); // clear button
...
class TitleBar extends JPanel {
    ...
    TitleBar() {
        ...
        JLabel titleText = new JLabel("Pengatur Jadwal"); // Text of the title bar
...
public class AplikasiPengaturJadwal {
